        ...
        <div>
            ...
            <div className="space-y-3 mb-6">
                ...
                <label
                    ...
                    {selectedType === 'resume' && (
                        <svg className="text-purple-600" width="11" height="8" viewBox="0 0 11 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10.7584 1.46323C11.0805 1.1285 11.0805 0.585786 10.7584 0.251051C10.4362 -0.0836837 9.91382 -0.0836837 9.59164 0.251051L4.125 5.93067L1.40836 3.10819C1.08618 2.77346 0.563819 2.77346 0.241637 3.10819C-0.0805456 3.44293 -0.0805456 3.98564 0.241637 4.32038L3.54164 7.74895C3.86382 8.08368 4.38618 8.08368 4.70836 7.74895L10.7584 1.46323Z" fill="currentColor"/>
                        </svg>
                    )}
                </label>
                ...
                <label
                    ...
                    {selectedType === 'cover-letter' && (
                        <svg className="text-orange-600" width="11" height="8" viewBox="0 0 11 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10.7584 1.46323C11.0805 1.1285 11.0805 0.585786 10.7584 0.251051C10.4362 -0.0836837 9.91382 -0.0836837 9.59164 0.251051L4.125 5.93067L1.40836 3.10819C1.08618 2.77346 0.563819 2.77346 0.241637 3.10819C-0.0805456 3.44293 -0.0805456 3.98564 0.241637 4.32038L3.54164 7.74895C3.86382 8.08368 4.38618 8.08368 4.70836 7.74895L10.7584 1.46323Z" fill="currentColor"/>
                        </svg>
                    )}
                </label>
